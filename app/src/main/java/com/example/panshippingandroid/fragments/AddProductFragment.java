...
public class AddProductFragment extends Fragment {
        ...
        if (isEdit) {
            ...
            addProductBtn.setOnClickListener(v -> {
                if (isEdit) {
                    ...
                    addProductBtn.setText("Edit");
                    editProductCall(id, setEditProduct(userID));
                }
            });
        } else {
            addImageIv.setOnClickListener(this::setImage);
    ...
    private ProductModel setEditProduct(Long userID) {
        isAllFieldsChecked = CheckAllFields();
        ProductModel productModel = new ProductModel();
        if (isAllFieldsChecked) {
            productModel.setId(id);
            ...
            image = ImageUtils.convertBitmapToStringImage(bitmap);
            productModel.setImage(image);
            if (Boolean.getBoolean("ordered")) {
                productModel.setOrdered(false);
            } else {
                productModel.setOrdered(true);
            }
        }
        return productModel;
    }
